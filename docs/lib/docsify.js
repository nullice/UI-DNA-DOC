(function () {
  ...
  renderer.image = function (href, title, text) {
    ...
    var out = "<img src=\"" + url + "\" data-origin=\"" + href + "\" alt=\"" + text + "\"" + titleHTML + ">"

    if (text != undefined && text.length != undefined && text.length > 0) {
      var title_box = '<div class="image-title"> <span> ' + text + "</span></div>"
    } else {
      var title_box = ""
    }

    out = '<div class="img-box">' + out + title_box + '</div>'
